                ...
                >
                    ...
                    <ListItem disablePadding sx={{ mb: 0.5 }}>
                        <ListItemButton
                            ...
                            selected={location.pathname === '/lesson-contents'}
                            sx={{
                                borderRadius: 2,
                                px: 2,
                                py: 1.5,
                        ...
                        >
                            <ListItemIcon sx={{ minWidth: 36, color: location.pathname === '/lesson-contents' ? 'primary.main' : 'text.secondary' }}>
                                <DashboardCustomizeIcon />
                            </ListItemIcon>
                            <ListItemText
                                primary="Lesson Contents"
                                primaryTypographyProps={{
                                    fontWeight: location.pathname === '/lesson-contents' ? 600 : 500,
                                    fontSize: '0.95rem'
                                }}
                            />
                            {location.pathname === '/lesson-contents' && (
                                <Box
                                    component={motion.div}
                                    layoutId="activeIndicator"
                                    sx={{
